      ...
      <Grid verticalAlign="middle">
        ...
        <GridRow centered>
          ...
          >
            <TableBody>
              <TableRow>
                <TableCell className="formheader">Group Name</TableCell>
                <TableCell>{group.group_name}</TableCell>
                <TableCell className="formheader">Group Type</TableCell>
                <TableCell>{group.group_type}</TableCell>
              </TableRow>
              <TableRow>
                <TableCell className="formheader">Group Items</TableCell>
